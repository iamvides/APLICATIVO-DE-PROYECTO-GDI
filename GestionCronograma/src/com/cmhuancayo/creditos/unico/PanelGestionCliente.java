...
public class PanelGestionCliente extends JPanel {
    ...
    public PanelGestionCliente(Cliente cliente) {
        ...
        setBorder(EstilosUI.BORDE_PANEL_INTERNO); // Margen
        EstilosUI.aplicarFondoClaro(this); // Fondo
    ...
    private JPanel crearPanelIzquierdo() {
        ...
        panel.setOpaque(false); // Fondo transparente, toma el del padre
        ...
        txtDNI.setBackground(EstilosUI.GRIS_FONDO); // Indicar que no es editable
        txtTelefono = new JTextField(cliente.getTelefono(), 20);

        // Aplicación de estilos de campos
        ...
        cmbCreditos.setRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList<?> list, Object value,
                ...
                if (value instanceof Credito) {
                    ...
                    String texto = String.format("Contrato %d - S/ %.2f (%d cuotas, %s)",
                                        c.getCodigoContrato(),
    ...
    private JPanel crearPanelCentralCronograma() {
        ...
        // Panel superior (Título y Resumen)
        ...
        for (JLabel l : arr) {
            EstilosUI.estilizarLabel(l); // Estilo
        }
        ...
        panelResumen.add(new JLabel()); // hueco
        ...
        // Renderizador para alinear N° de cuota al centro
        DefaultTableCellRenderer centerRenderer = new DefaultTableCellRenderer();
        centerRenderer.setHorizontalAlignment(SwingConstants.CENTER);
        
        // Renderizador para alinear valores monetarios a la derecha
        DefaultTableCellRenderer rightRenderer = new DefaultTableCellRenderer();
        rightRenderer.setHorizontalAlignment(SwingConstants.RIGHT);
        
        // Aplicar renderizadores y anchos de columna
        ...
        toolBarAcciones.setBorder(new EmptyBorder(10, 0, 0, 0)); // Margen superior
        ...
        // Agregando componentes a la barra de herramientas
        toolBarAcciones.add(btnHistorial);
        toolBarAcciones.add(Box.createHorizontalStrut(20)); // Separador
        ...
        toolBarAcciones.add(btnRegistrarPago); // Botón principal al final
    ...
    private void actualizarResumen(Credito c) {
        ...
        String nombreCompleto = (cliente.getApellidoPaterno() != null ? cliente.getApellidoPaterno() + " " : "")
        ...
        // Usamos etiquetas más descriptivas
    ...
    /* -------------------------------------------------------
     * Acciones (Lógica restaurada y sin cambios funcionales)
     * ------------------------------------------------------- */
    ...
    private Cuota obtenerCuotaSeleccionada() {
        ...
        if (filaVista == -1) {
            JOptionPane.showMessageDialog(this, "Seleccione una cuota de la tabla.", "Aviso", JOptionPane.WARNING_MESSAGE);
            return null;
        }
    ...
    private void registrarPagoCuota(ActionEvent e) {
        if (creditoSeleccionado == null) {
            JOptionPane.showMessageDialog(this, "Seleccione primero un crédito.", "Aviso", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        if ("Pagada".equalsIgnoreCase(cuota.getEstadoCuota())) {
            JOptionPane.showMessageDialog(this, "Esta cuota ya está pagada.",
    ...
    private void pagoParcial(ActionEvent e) {
        ...
        if ("Pagada".equalsIgnoreCase(cuota.getEstadoCuota())) {
            JOptionPane.showMessageDialog(this, "Esta cuota ya está pagada.", "Advertencia", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        if (ok) {
            JOptionPane.showMessageDialog(this, "Pago parcial registrado correctamente.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
            cargarCronogramaSeleccionado();
        } else {
             JOptionPane.showMessageDialog(this, "No se pudo registrar el pago parcial.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void amortizacionCapital(ActionEvent e) {
        ...
        String montoStr = JOptionPane.showInputDialog(this,
                "Ingrese el monto a amortizar (S/):", "Amortización de capital",
                JOptionPane.QUESTION_MESSAGE);
        if (montoStr == null) return;
    ...
    private void verHistorialCronograma(ActionEvent e) { // Añadido el parámetro
        if (creditoSeleccionado == null) {
            JOptionPane.showMessageDialog(this,
                    "Seleccione primero un crédito.", "Aviso",
                    JOptionPane.WARNING_MESSAGE);
            return;
        }
    ...
    // Sobrecarga del método por compatibilidad (aunque no se use)
