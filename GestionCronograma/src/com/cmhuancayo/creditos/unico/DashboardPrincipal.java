...
public class DashboardPrincipal extends JFrame {
    ...
    SwingUtilities.invokeLater(() -> {
        // 1) Intentar conexión (aquí se disparará el panel para crear la BD si no existe)
        ...
        if (conn != null) {
            ...
            // 2) Si todo OK, recién mostramos la ventana principal
            new DashboardPrincipal().setVisible(true);
        } else {
            // Si de verdad no se pudo conectar / crear, avisamos y salimos
            JOptionPane.showMessageDialog(
                    null,
                    "No se pudo establecer conexión con la base de datos.\n" +
                    "Verifique los datos de PostgreSQL.",
                    "Error de conexión",
