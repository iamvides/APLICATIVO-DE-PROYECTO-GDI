...
public class CreditoDAO {
    ...
    /**
     * Crea un crédito completo (solicitud + pre_aprobación + contrato + cronograma)
     * usando el SP sp_CrearCreditoClienteBasico.
     * Devuelve el código del contrato creado, o -1 si hubo error.
     */
    ...
    public boolean actualizarContratoReprogramado(int codigoContrato,
        ...
        try {
            ...
            if (nuevaTasaAnual == null) {
                ps.setBigDecimal(1, BigDecimal.ZERO);
            } else {
                ps.setBigDecimal(1, nuevaTasaAnual);
            }
     ...
     * (Se asume que el nuevo contrato ya fue creado correctamente.)
     */
